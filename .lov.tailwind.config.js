  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        atlantis: {
          navy: "hsl(var(--atlantis-navy))",
          deep: "hsl(var(--atlantis-deep))",
          cyan: "hsl(var(--atlantis-cyan))",
          magenta: "hsl(var(--atlantis-magenta))",
          glow: "hsl(var(--atlantis-glow))",
          surface: "hsl(var(--atlantis-surface))",
          "surface-elevated": "hsl(var(--atlantis-surface-elevated))"
        },
        sidebar: {
